...
// Die Variable in der gespeichert wird, auf wieviele Nachkommastellen gerundet
// werden soll, bevor das Ergebnis ausgegeben wird.
let resultsDecimals = 1;

// Im folgenden Abschnitt werden den input- und select-Elementen sogenannte
// Event Listener hinzugefuegt, die beim Betaetigen einer Enter-Taste die 
// Funktion submitData aufrufen.
document.getElementById('inputBandwidth').addEventListener("keydown", function (e) {
  if(e.keyCode == 13){
    submitData();
}})

document.getElementById('inputDataAmount').addEventListener("keydown", function (e) {
  if(e.keyCode == 13){
    submitData();
}})
...
document.getElementById('selectBandwidthUnit').addEventListener("keydown", function (e) {
  if(e.keyCode == 13){
    submitData();
}})

document.getElementById('selectDataAmountUnit').addEventListener("keydown", function (e) {
  if(e.keyCode == 13){
    submitData();
}})

document.getElementById('selectTimeUnit').addEventListener("keydown", function (e) {
  if(e.keyCode == 13){
    submitData();
}}) 
